...
ActiveRecord::Schema.define(version: 20140702175046) do
  ...
  add_index "following_relationships", ["follower_id", "followed_user_id"], name: "following_relation_unique_constraint", unique: true, using: :btree
